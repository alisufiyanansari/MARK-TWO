## CLI Quiz App on APJ Abdul Kalam, Made with JavaScript.

It is developed in JavaScript on [repl.it](https://replit.com/@13-AliAli/Mark2-AbulKalamQuiz?v=1) in Node.js environment.
